      ...
      <div className="container">
        <div className="content-service">
          <div className="content-service-grid-ref">
            ...
            <div className="content-service-grid-ref-item">
              <p>
                เว็บไซต์นี้เป็นเว็บเกี่ยวกับศัพท์เทคนิคทางการแพทย์ที่บุคลากรทางการแพทย์สามารถนำไปใช้ในการ
                <br></br>
                ...
                ซึ่งเว็บไซต์นี้เป็นเว็บที่สร้างขึ้นมาเพื่อให้ความรู้เกี่ยวกับศัพท์เทคนิคทางการแพทย์แก่ผู้ประสานงานด้านการแพทย์ภาษาจีนและบุคลากรทางการแพทย์ให้มีความรู้ในศัพท์ภาษาจีนที่ต้องใช้ในการทำงานให้มีมากยิ่งขึ้น
            ...
            <div className="content-service-item">
              <a href="/symptom">
                <div className="link">
                  ...
                  {/* <h2>疾病</h2> */}
                  <p>คำศัพท์ภาษาจีนเกี่ยวกับการแสดงอาการต่างๆ</p>
                </div>
              </a>
            </div>
            {/* ----------------------------------------------- 4 ----------------------------------------------- */}
            ...
            <div className="content-service-item">
              <a href="/tools">
                <div className="link">
                  ...
                  {/* <h2>疾病</h2> */}
                  <p>คำศัพท์ภาษาจีนเกี่ยวกับเครื่องมือทางการแพทย์</p>
                </div>
              </a>
            </div>
            {/* ----------------------------------------------- 6 ----------------------------------------------- */}
